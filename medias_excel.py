...
print("Archivos CSV generados en los directorios {} y {}".format(directory_name_masc, directory_name_fem))
...
archivo_junto="./medias_masc/medias_junto.csv"
...
archivo_junto="./medias_fem/medias_junto.csv"
# Abrir un archivo nuevo donde se escribirán todas las líneas juntas
with open(archivo_junto, 'w') as archivo_final:
    # Recorrer cada archivo .xd y escribir sus líneas en el archivo final
    for nombre_archivo in archivos:
