...
for idx, mejor_combinacion in enumerate(mejores_combinaciones):
    print("Combinación", idx+1)
    print("Equipo 1:")
    for nadador in mejor_combinacion[0]:
        print(nadador[0], nadador[1])
    print("Equipo 2:")
    for nadador in mejor_combinacion[1]:
        print(nadador[0], nadador[1])
    print("Equipo 3:")
    for nadador in mejor_combinacion[2]:
        print(nadador[0], nadador[1])
